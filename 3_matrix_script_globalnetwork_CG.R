...
distance_full <- feather::read_feather("Data/distance_full_CG.feather")

first_instance_base <- distance_full %>%
  dplyr::select(Speaker, Gloss, age) %>%
  ...
  rename("AOP" = "age",
         "gloss1" = "Gloss") %>%
  write_csv("Data/first_instance_CG.csv")

# Figure out the first production of each word

first_instance <- distance_full %>%     # figure out which month each word was first produced
  group_by(Speaker, Gloss)  %>%
  filter(age == min(age)) %>% 
...
data_list <- first_instance %>% 
  #filter(nsyl_target < 3) %>% # data set is massive so split into syllables
  #select(-contains(c("S3", "S4"))) %>%
  split(., f = .$subj_session) 

first_instance_list <- lapply(data_list, FUN = function(element) {
  cumulative_vocab <- first_instance %>%
    filter(Speaker == element$Speaker & age <= element$age)
})

global_matrix <- lapply(first_instance_list, FUN = function(element) {
  ...
  # 
  # sonorant_vec.S4CF1 <- element$S4CF1.Sonorant
  # sonorant_mat.S4CF1 <- (sonorant_vec.S4CF1 %*% t(ones) - ones %*% t(sonorant_vec.S4CF1))^2
  # 
  # consonantal_vec.S4CF1 <- element$S4CF1.Consonantal
  # consonantal_mat.S4CF1 <- (consonantal_vec.S4CF1 %*% t(ones) - ones %*% t(consonantal_vec.S4CF1))^2
  # 
  # voice_vec.S4CF1 <- element$S4CF1.Voice
  # voice_mat.S4CF1 <- (voice_vec.S4CF1 %*% t(ones) - ones %*% t(voice_vec.S4CF1))^2
  # 
  # nasal_vec.S4CF1 <- element$S4CF1.Nasal
  # nasal_mat.S4CF1 <- (nasal_vec.S4CF1 %*% t(ones) - ones %*% t(nasal_vec.S4CF1))^2
  # 
  # degree_vec.S4CF1 <- element$S4CF1.Degree
  # degree_mat.S4CF1 <- (degree_vec.S4CF1 %*% t(ones) - ones %*% t(degree_vec.S4CF1))^2
  # 
  # labial_vec.S4CF1 <- element$S4CF1.Labial
  # labial_mat.S4CF1 <- (labial_vec.S4CF1 %*% t(ones) - ones %*% t(labial_vec.S4CF1))^2
  # 
  # palatal_vec.S4CF1 <- element$S4CF1.Palatal
  # palatal_mat.S4CF1 <- (palatal_vec.S4CF1 %*% t(ones) - ones %*% t(palatal_vec.S4CF1))^2
  # 
  # pharyngeal_vec.S4CF1 <- element$S4CF1.Pharyngeal
  # pharyngeal_mat.S4CF1 <- (pharyngeal_vec.S4CF1 %*% t(ones) - ones %*% t(pharyngeal_vec.S4CF1))^2
  # 
  # round_vec.S4CF1 <- element$S4CF1.Round
  # round_mat.S4CF1 <- (round_vec.S4CF1 %*% t(ones) - ones %*% t(round_vec.S4CF1))^2
  # 
  # tongue_vec.S4CF1 <- element$S4CF1.Tongue
  # tongue_mat.S4CF1 <- (tongue_vec.S4CF1 %*% t(ones) - ones %*% t(tongue_vec.S4CF1))^2
  # 
  # radical_vec.S4CF1 <- element$S4CF1.Radical
  # radical_mat.S4CF1 <- (radical_vec.S4CF1 %*% t(ones) - ones %*% t(radical_vec.S4CF1))^2
  # 
  # mat.S4CF1 <- sonorant_mat.S4CF1 + 
  #   consonantal_mat.S4CF1 + 
  #   voice_mat.S4CF1 + 
  #   nasal_mat.S4CF1 + 
  #   degree_mat.S4CF1 + 
  #   labial_mat.S4CF1 + 
  #   palatal_mat.S4CF1 + 
  #   pharyngeal_mat.S4CF1 + 
  #   round_mat.S4CF1 + 
  #   tongue_mat.S4CF1 + 
  #   radical_mat.S4CF1
  # 
  # rownames(mat.S4CF1) <- element$Gloss
  # colnames(mat.S4CF1) <- element$Gloss
  # 
  # sonorant_vec.S4CF2 <- element$S4CF2.Sonorant
  # sonorant_mat.S4CF2 <- (sonorant_vec.S4CF2 %*% t(ones) - ones %*% t(sonorant_vec.S4CF2))^2
  # 
  # consonantal_vec.S4CF2 <- element$S4CF2.Consonantal
  # consonantal_mat.S4CF2 <- (consonantal_vec.S4CF2 %*% t(ones) - ones %*% t(consonantal_vec.S4CF2))^2
  # 
  # voice_vec.S4CF2 <- element$S4CF2.Voice
  # voice_mat.S4CF2 <- (voice_vec.S4CF2 %*% t(ones) - ones %*% t(voice_vec.S4CF2))^2
  # 
  # nasal_vec.S4CF2 <- element$S4CF2.Nasal
  # nasal_mat.S4CF2 <- (nasal_vec.S4CF2 %*% t(ones) - ones %*% t(nasal_vec.S4CF2))^2
  # 
  # degree_vec.S4CF2 <- element$S4CF2.Degree
  # degree_mat.S4CF2 <- (degree_vec.S4CF2 %*% t(ones) - ones %*% t(degree_vec.S4CF2))^2
  # 
  # labial_vec.S4CF2 <- element$S4CF2.Labial
  # labial_mat.S4CF2 <- (labial_vec.S4CF2 %*% t(ones) - ones %*% t(labial_vec.S4CF2))^2
  # 
  # palatal_vec.S4CF2 <- element$S4CF2.Palatal
  # palatal_mat.S4CF2 <- (palatal_vec.S4CF2 %*% t(ones) - ones %*% t(palatal_vec.S4CF2))^2
  # 
  # pharyngeal_vec.S4CF2 <- element$S4CF2.Pharyngeal
  # pharyngeal_mat.S4CF2 <- (pharyngeal_vec.S4CF2 %*% t(ones) - ones %*% t(pharyngeal_vec.S4CF2))^2
  # 
  # round_vec.S4CF2 <- element$S4CF2.Round
  # round_mat.S4CF2 <- (round_vec.S4CF2 %*% t(ones) - ones %*% t(round_vec.S4CF2))^2
  # 
  # tongue_vec.S4CF2 <- element$S4CF2.Tongue
  # tongue_mat.S4CF2 <- (tongue_vec.S4CF2 %*% t(ones) - ones %*% t(tongue_vec.S4CF2))^2
  # 
  # radical_vec.S4CF2 <- element$S4CF2.Radical
  # radical_mat.S4CF2 <- (radical_vec.S4CF2 %*% t(ones) - ones %*% t(radical_vec.S4CF2))^2
  # 
  # mat.S4CF2 <- sonorant_mat.S4CF2 + 
  #   consonantal_mat.S4CF2 + 
  #   voice_mat.S4CF2 + 
  #   nasal_mat.S4CF2 + 
  #   degree_mat.S4CF2 + 
  #   labial_mat.S4CF2 + 
  #   palatal_mat.S4CF2 + 
  #   pharyngeal_mat.S4CF2 + 
  #   round_mat.S4CF2 + 
  #   tongue_mat.S4CF2 + 
  #   radical_mat.S4CF2
  # 
  # rownames(mat.S4CF2) <- element$Gloss
  # colnames(mat.S4CF2) <- element$Gloss
  # 
  # sonorant_vec.S4CF3 <- element$S4CF3.Sonorant
  # sonorant_mat.S4CF3 <- (sonorant_vec.S4CF3 %*% t(ones) - ones %*% t(sonorant_vec.S4CF3))^2
  # 
  # consonantal_vec.S4CF3 <- element$S4CF3.Consonantal
  # consonantal_mat.S4CF3 <- (consonantal_vec.S4CF3 %*% t(ones) - ones %*% t(consonantal_vec.S4CF3))^2
  # 
  # voice_vec.S4CF3 <- element$S4CF3.Voice
  # voice_mat.S4CF3 <- (voice_vec.S4CF3 %*% t(ones) - ones %*% t(voice_vec.S4CF3))^2
  # 
  # nasal_vec.S4CF3 <- element$S4CF3.Nasal
  # nasal_mat.S4CF3 <- (nasal_vec.S4CF3 %*% t(ones) - ones %*% t(nasal_vec.S4CF3))^2
  # 
  # degree_vec.S4CF3 <- element$S4CF3.Degree
  # degree_mat.S4CF3 <- (degree_vec.S4CF3 %*% t(ones) - ones %*% t(degree_vec.S4CF3))^2
  # 
  # labial_vec.S4CF3 <- element$S4CF3.Labial
  # labial_mat.S4CF3 <- (labial_vec.S4CF3 %*% t(ones) - ones %*% t(labial_vec.S4CF3))^2
  # 
  # palatal_vec.S4CF3 <- element$S4CF3.Palatal
  # palatal_mat.S4CF3 <- (palatal_vec.S4CF3 %*% t(ones) - ones %*% t(palatal_vec.S4CF3))^2
  # 
  # pharyngeal_vec.S4CF3 <- element$S4CF3.Pharyngeal
  # pharyngeal_mat.S4CF3 <- (pharyngeal_vec.S4CF3 %*% t(ones) - ones %*% t(pharyngeal_vec.S4CF3))^2
  # 
  # round_vec.S4CF3 <- element$S4CF3.Round
  # round_mat.S4CF3 <- (round_vec.S4CF3 %*% t(ones) - ones %*% t(round_vec.S4CF3))^2
  # 
  # tongue_vec.S4CF3 <- element$S4CF3.Tongue
  # tongue_mat.S4CF3 <- (tongue_vec.S4CF3 %*% t(ones) - ones %*% t(tongue_vec.S4CF3))^2
  # 
  # radical_vec.S4CF3 <- element$S4CF3.Radical
  # radical_mat.S4CF3 <- (radical_vec.S4CF3 %*% t(ones) - ones %*% t(radical_vec.S4CF3))^2
  # 
  # mat.S4CF3 <- sonorant_mat.S4CF3 + 
  #   consonantal_mat.S4CF3 + 
  #   voice_mat.S4CF3 + 
  #   nasal_mat.S4CF3 + 
  #   degree_mat.S4CF3 + 
  #   labial_mat.S4CF3 + 
  #   palatal_mat.S4CF3 + 
  #   pharyngeal_mat.S4CF3 + 
  #   round_mat.S4CF3 + 
  #   tongue_mat.S4CF3 + 
  #   radical_mat.S4CF3
  # 
  # rownames(mat.S4CF3) <- element$Gloss
  # colnames(mat.S4CF3) <- element$Gloss
  # 
  ...
  rownames(mat.SFCF1) <- element$Gloss
  colnames(mat.SFCF1) <- element$Gloss
  ...
  rownames(mat.SFCF2) <- element$Gloss
  colnames(mat.SFCF2) <- element$Gloss
  ...
  rownames(mat.SFCF3) <- element$Gloss
  colnames(mat.SFCF3) <- element$Gloss
...
globaldistance_melted <- reshape2::melt(global_matrix) %>% as.data.frame()

globaldistance <- #reshape2::melt(global_matrix_2syl) %>%   # turn list into a df
  globaldistance_melted %>%
  #filter(stringr::str_detect(L1, 'Alex')) %>%
  rename("gloss1" = "Var1",
         "gloss2" = "Var2",
         "distance" = "value") %>%
...
#feather::write_feather(globaldistance, "Data/globaldistance_CG_prelim.feather")

#globaldistance <- feather::read_feather("Data/globaldistance_CG_prelim.feather")

globaldistance_lily <- globaldistance %>% filter(Speaker == "Lily")
globaldistance_naima <- globaldistance %>% filter(Speaker == "Naima")
globaldistance_others <- globaldistance %>% filter(Speaker %notin% c("Lily", "Naima"))

globaldistance_list_others <- list(globaldistance_others)

globaldistance_list_others <- lapply(globaldistance_list_others, FUN = function(element) {
  ...
  globaldistance_speaker_swapped <- globaldistance_speaker %>%
    rename("gloss1" = "gloss2",              # swapping these around so that all word pairs are consdiered with gloss1 as 'main' component below
           "gloss2" = "gloss1")
  globaldistance_speaker <- rbind(globaldistance_speaker, globaldistance_speaker_swapped)
  globaldistance_ready <- globaldistance_speaker %>%
  ...
  globaldistance_final <- list(globaldistance_ready)
})

globaldistance_list_lily <- list(globaldistance_lily)

globaldistance_list_lily <- lapply(globaldistance_list_lily, FUN = function(element) {
...
globaldistance_list_naima <- list(globaldistance_naima)

globaldistance_list_naima <- lapply(globaldistance_list_naima, FUN = function(element) {
...
globaldistance_CG_others <- melt(globaldistance_list_others) %>%
  pivot_wider(names_from = variable, values_from = value) %>%
  dplyr::select(-L1, -L2)

#feather::write_feather(globaldistance_CG_others, "Data/globaldistance_CG_others.feather")
#globaldistance_CG_others <- feather::read_feather("Data/globaldistance_CG_others.feather")


globaldistance_CG_lily <- melt(globaldistance_list_lily) %>%
  pivot_wider(names_from = variable, values_from = value) %>%
  dplyr::select(-L1, -L2)

#feather::write_feather(globaldistance_CG_lily, "Data/globaldistance_CG_lily.feather")
#globaldistance_CG_lily <- feather::read_feather("Data/globaldistance_CG_lily.feather")

globaldistance_CG_naima <- melt(globaldistance_list_naima) %>%
  pivot_wider(names_from = variable, values_from = value) %>%
  dplyr::select(-L1, -L2)

#feather::write_feather(globaldistance_CG_naima, "Data/globaldistance_CG_naima.feather")
globaldistance_CG_naima <- feather::read_feather("Data/globaldistance_CG_naima.feather")

globaldistance_CG <- globaldistance_CG_others %>% 
  bind_rows(globaldistance_CG_lily) %>%
  bind_rows(globaldistance_CG_naima)

feather::write_feather(globaldistance_CG, "Data/globaldistance_CG.feather")
