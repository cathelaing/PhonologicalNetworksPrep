...
globaldistance_lyon_actual <- feather::read_feather("Data/globaldistance_Lyon_rand.feather") %>% 
...
globaldistance_lyon_target <- feather::read_feather("Data/globaldistance_lyon_rand.feather") %>% filter(data_type == "target")
