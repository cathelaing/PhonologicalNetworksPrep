...
first_instance_base <- read_csv("Data/first_instance_Lyon.csv")
...
feather::write_feather(globalthresholds_corr_lyon, "Data/globalthresholds_corr_lyon_subset.feather") # correlation output data
feather::write_feather(globalthresholds_lyon, "Data/globalthresholds_lyon_subset.feather") # all types at all ages, plus AOP data
feather::write_feather(globalthresholds_AOP_lyon, "Data/globalthresholds_AOP_lyon_subset.feather") # AOP for full network, taken at last month of data (30 months)
